...
def median(args):
    ...
    middle value of the ordered elements. If the number of elements is even,
    the median is the mean value of the two middle values.
...
def quartile(args):
    ...
    The quartiles are defined as the median value of the lower or upper half of 
    the sorted number set. If the number of elements is odd, the middle element
    ...
    mid = len(lst) // 2
    if len(lst) % 2 == 1:
        return [median(lst[:mid+1]), median(lst[mid:])]
    else:
...
def std(args):
    ...
    calculated as the square root of the sum of the squared distance to the
    mean of all elements divided by the number of elements.
...
def var(args):
    ...
    squared average distance of all values to the mean. This is calculated as
    the sum of the squared distance to the mean of all elements divided by the
    number of elements.
